...
const MESSAGES = {
  ...
  'home.heroTitle': ['Chargeurs en gros pour votre boutique', 'شواحن بالجملة لمحلك'],
  'home.heroText': [
  ...
  'home.packsSub': ['Achetez en volume, revendez au détail', 'اشترِ بالجملة وبِع بالتجزئة'],
  'home.promos': ['Promotions', 'التخفيضات'],
  'home.promosSub': ['Les meilleures remises du moment', 'أفضل التخفيضات حاليا'],
  'home.brands': ['Nos marques', 'علاماتنا'],
  'home.brandsSub': ['Choisissez une marque pour voir ses chargeurs', 'اختر علامة لعرض شواحنها'],
  'home.seeAll': ['Tout voir', 'عرض الكل'],
  'home.arg1Title': ['Prix revendeur', 'أسعار الجملة'],
  'home.arg1Text': ['Des tarifs dégressifs pensés pour les boutiques.', 'أسعار تنازلية مدروسة للمحلات.'],
  'home.arg2Title': ['58 wilayas', '58 ولاية'],
  'home.arg2Text': ['Livraison partout en Algérie via Yalidine.', 'التوصيل لكل الجزائر عبر Yalidine.'],
  'home.arg3Title': ['Paiement à la livraison', 'الدفع عند الاستلام'],
  'home.arg3Text': ['Vous payez le colis à sa réception.', 'تدفع ثمن الطرد عند استلامه.'],
  ...
  'pack.empty': ['Aucun pack disponible pour le moment.', 'لا توجد باقات متوفرة حاليا.'],
  ...
  'list.empty': ['Aucun produit ne correspond à cette recherche.', 'لا يوجد منتج يطابق البحث.'],
  ...
  'brand.empty': ['Cette marque n’a aucun produit en stock.', 'لا توجد منتجات متوفرة لهذه العلامة.'],
  ...
  'tracking.intro': ['Saisissez votre référence et votre téléphone.', 'أدخل رقم طلبك ورقم هاتفك.'],
